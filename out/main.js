var e = {
  ...
  9029: (e, t, r) => {
    ...
    class $ extends y {
      ...
      optimizeNames(e, t) {
        var r
        if (
          ((this.else = null === (r = this.else) || void 0 === r ? void 0 : r.optimizeNames(e, t)),
    ...
    ;(j.kind = "finally"),
      (t.CodeGen = class {
        ...
        try(e, t, r) {
          ...
          return (
            r && ((this._currNode = a.finally = new j()), this.code(r)), this._endBlockNode(k, j)
          )
        }
        throw(e) {
    ...
    ;(t.keywordError = {message: ({keyword: e}) => a.str`must pass "${e}" keyword validation`}),
      (t.keyword$DataError = {
        message: ({keyword: e, schemaType: t}) =>
          t ? a.str`"${e}" keyword must be ${t} ($data)` : a.str`"${e}" keyword is invalid ($data)`,
      }),
    ...
    ;(t.toHash = function (e) {
      ...
      (t.mergeEvaluated = {
        ...
        items: d({
          ...
          mergeToName: (e, t, r) =>
            e.if(a._`${r} !== true`, () => e.assign(r, !0 === t || a._`${r} > ${t} ? ${r} : ${t}`)),
                ...
                e.if(
                  ...
                  () => {
                    e.var(
                      ...
                      e.var(l.default.parentData, u._`${l.default.valCxt}.${l.default.parentData}`),
                      e.var(
                ...
                ((function (e, t) {
                  t.length &&
                    (e.dataTypes.length
                      ? (t.forEach((t) => {
                          S(e.dataTypes, t) ||
                            P(e, `type "${t}" not allowed by context "${e.dataTypes.join(",")}"`)
                        }),
                        (function (e, t) {
                          const r = []
  ...
  4042: (e, t, r) => {
    ...
    function _(e) {
      ...
      return {
        strictSchema:
          null === (n = null !== (o = e.strictSchema) && void 0 !== o ? o : j) || void 0 === n || n,
        strictNumbers:
      ...
      removeSchema(e) {
        ...
        switch (typeof e) {
          ...
          case "object": {
            ...
            return (
              r && ((r = (0, u.normalizeId)(r)), delete this.schemas[r], delete this.refs[r]), this
            )
          }
          default:
  ...
  3853: (e, t) => {
    ...
    function r(e) {
      ...
      for (; s < t; )
        a++,
          (r = e.charCodeAt(s++)),
          r >= 55296 && r <= 56319 && s < t && ((r = e.charCodeAt(s)), 56320 == (64512 & r) && s++)
      return a
    }
    Object.defineProperty(t, "__esModule", {value: !0}),
      (t.default = r),
    ...
    function i(e, t, r = e.schema) {
      ...
      r.forEach((t, r) => {
        ;(0, s.alwaysValidSchema)(d, t) ||
          (o.if(a._`${l} > ${r}`, () => e.subschema({keyword: c, schemaProp: r, dataProp: r}, u)),
          e.ok(u))
      })
    }
    ...
    const a = r(5765),
      ...
      i = {
        ...
        code(e) {
          ...
          if (0 === l.length || (f.length === l.length && (!d.opts.unevaluated || !0 === d.props)))
            return
  ...
  5765: (e, t, r) => {
    ...
    ;(t.checkReportMissingProp = function (e, t) {
      ...
      (t.callValidateCode = function (
        {schemaCode: e, data: t, it: {gen: r, topSchemaRef: s, schemaPath: n, errorPath: i}, it: c},
        d,
        u,
        l
      ) {
    ...
    function l(e, t, r, a) {
      ...
      a
        ? (function () {
            ...
            i.try(
              () => {
                i.code(o._`await ${(0, s.callValidateCode)(e, t, h)}`), m(t), u || i.assign(r, !0)
              },
              (e) => {
            ...
            (d.allErrors
              ...
              : (function () {
                  ...
                  if (l || c) {
                    ...
                    t.if((0, a.checkMissingProp)(e, r, o)), (0, a.reportMissingProp)(e, o), t.else()
                })(),
            u.strictRequired)
          ) {
  ...
  617: (e, t, r) => {
    ...
    const a = r(208),
      ...
      i = {
        ...
        code(e) {
          const {gen: t, data: r, $data: i, schema: c, parentSchema: d, schemaCode: u, it: l} = e
          if (!i && !c) return
          const f = t.let("valid"),
    ...
    !(function (e) {
          ...
          if (t.unicodeSupport || (o && o.unicodeSupport)) j(r, a)
            ...
            if (r.host && (t.domainHost || (o && o.domainHost)))
              try {
                ...
                r.error =
                  r.error || "Host's domain name can not be converted to ASCII via punycode: " + e
              }
            j(r, n)
          }
      ...
      ;(P[K.scheme] = K),
        ...
        (e.normalize = function (e, t) {
          return (
            "string" == typeof e ? (e = F(R(e, t), t)) : "object" === a(e) && (e = R(F(e, t), t)), e
          )
        }),
